      ...
      <Animated animationIn="fadeInUp" animationInDuration={3000}>
        ...
        <div className="wrapper-about">
          ...
          <div className="text-about">
            <p>
              After more than a decade of working on high-end content for
              national consumer brands and independent entertainment houses,
              Erix dove headfirst into showcasing his directorial skills in a
              diverse range of commercial genres. Using experience and expertise
              to strategically build brand awareness through customized
              storytelling and social media strategy, he was able to land a spot
              on six film festivals and win three awards for best commercial.
            </p>
            <p>
